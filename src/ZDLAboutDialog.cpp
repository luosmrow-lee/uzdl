...
ZDLAboutDialog::ZDLAboutDialog(ZDLWidget *parent):QDialog(parent){
	setWindowTitle("About " ZDL_APP_NAME);
	setWindowFlags(windowFlags()&~Qt::WindowContextHelpButtonHint); 
	QVBoxLayout *box = new QVBoxLayout(this);
	QHBoxLayout *hbox = new QHBoxLayout();
	box->addLayout(hbox);
	QVBoxLayout *vbox = new QVBoxLayout();
	QLabel *title = new QLabel(QString(ZDL_APP_NAME)+" "+ZDL_VERSION_STRING,this);
	...
	box->addWidget(hrTop);
	box->addWidget(new QLabel("Copyright (c) 2026 luosmrow-lee", this));
	...
	QLabel *url = new QLabel("<a href=https://github.com/luosmrow-lee/uzdl>GitHub/uzdl</a> - based on <a href=https://github.com/lcferrum/qzdl>Lcferrum's ZDL</a>",this);
